...
TextEditor::EnterCharacter(ImWchar aChar, bool aShift)
{
    ...
    if (HasSelection()) {
        if (aChar == '\t' &&
            ...
            if (modified) {
                start =
                  Coordinates(start.mLine, GetCharacterColumn(start.mLine, 0));
...
void
TextEditor::SetSelection(const Coordinates& aStart,
...
static bool
TokenizeCStyleString(const char*  in_begin,
                     const char*  in_end,
...
static bool
TokenizeCStyleCharacterLiteral(const char*  in_begin,
                               const char*  in_end,
                               const char*& out_begin,
                               const char*& out_end)
{
...
static bool
TokenizeCStyleIdentifier(const char*  in_begin,
                         const char*  in_end,
                         const char*& out_begin,
                         const char*& out_end)
{
...
static bool
TokenizeCStyleNumber(const char*  in_begin,
                     const char*  in_end,
                     const char*& out_begin,
                     const char*& out_end)
{
...
static bool
TokenizeCStylePunctuation(const char*  in_begin,
                          const char*  in_end,
                          const char*& out_begin,
                          const char*& out_end)
{
