...
INSTANCE_LEVEL_VULKAN_FUNCTION( vkCreateSemaphore )
INSTANCE_LEVEL_VULKAN_FUNCTION( vkDestroySemaphore )
...
INSTANCE_LEVEL_VULKAN_FUNCTION_FROM_EXTENSION(
		vkCmdBeginDebugUtilsLabelEXT, VK_EXT_DEBUG_UTILS_EXTENSION_NAME )
INSTANCE_LEVEL_VULKAN_FUNCTION_FROM_EXTENSION(
		vkCmdEndDebugUtilsLabelEXT, VK_EXT_DEBUG_UTILS_EXTENSION_NAME )
INSTANCE_LEVEL_VULKAN_FUNCTION_FROM_EXTENSION(
		vkCmdInsertDebugUtilsLabelEXT, VK_EXT_DEBUG_UTILS_EXTENSION_NAME )
INSTANCE_LEVEL_VULKAN_FUNCTION_FROM_EXTENSION(
